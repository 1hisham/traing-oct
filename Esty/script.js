...
function categorylist() {
  ...
  function calculationDiscount(products) {
    ...
    products.forEach(item =>{
      ...
      discountPrice =
      item.amount.originalPrice *
      (item.amount.discount / 100);
      console.log(item.amount.originalPrice);
      price = item.amount.originalPrice - discountPrice;
  ...
  function starRatingAmount(key) {
    ...
    function apiFunction(){
      ...
      fetch(
        ...
        .then((popularGiftsNow) => {
          ...
          starRatingAmount(popularGiftsNow);
    ...
    apiFunction()
        ...
        //     sortedArray = popularGiftsNow;
        //     let searchNumber = inputValue.value;
        //     console.log(sortedArray, "sorted");
        //     sortedArray = popularGiftsNow.filter((item) => {
      ...
      ) 
      {
        ...
        imageText.innerHTML = item.caption;
        ...
        starRating.innerHTML = item.rating.amountofRating;
      ...
      function updatingFunction(products) {
        products.forEach(item =>{
          
          console.log(item,"toatl ita,s");
          popularGiftCardSingle(
            item,
            starRatingAmount(item.rating.stars),
            calculationDiscount()
